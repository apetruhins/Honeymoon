        ...
        ScrollView(.vertical, showsIndicators: false) {
            ...
            VStack(alignment: .center, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 25) {
                    GuideComponent(title: "Like", subtitle: "Swipe right", description: "Do you like the destination? Touch the screen and swipe right. It will be saved to favorites.", icon: "heart.circle")
